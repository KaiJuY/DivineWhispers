...
const enTranslations = {
  ...
  pages: {
    ...
    fortuneAnalysis: {
      ...
      analysisTitle: "Divination Poem Analysis",
    ...
    report: {
      ...
      lineByLineInterpretation: "Line-by-Line Interpretation",
...
const zhTranslations = {
  ...
  pages: {
    ...
    report: {
      ...
      backToAccount: "← 返回帳戶",
      yourQuestion: "您的問題",
      lineByLineInterpretation: "詩詞逐句解釋",
      overallDevelopment: "整體發展",
...
const jpTranslations = {
  ...
  pages: {
    ...
    report: {
      ...
      yourQuestion: "あなたの質問",
      lineByLineInterpretation: "行ごとの解釈",
      overallDevelopment: "全体的な発展",
      positiveFactors: "ポジティブな要因",
      challenges: "課題",
      suggestedActions: "提案されたアクション",
      supplementaryNotes: "補足説明",
      conclusion: "結論",
