...
class GuanYin100Crawler:
    ...
    def crawl(self, export_json: bool = False):
        Baseurl = "https://qiangua.temple01.com/qianshi.php?t=fs_yin100"
    ...
    def get_analysis_info(self, bs):
        ...
        s_analyse = P_analyse_div.find_all("div", class_="fs_box fs_lang")
        sub_line_count = 0
        zh=""
        jp=""
        en=""
